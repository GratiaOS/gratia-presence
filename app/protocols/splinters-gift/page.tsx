...
function PageContent() {
  ...
  const fm =
    frontmatters['splinters-gift'][locale as keyof (typeof frontmatters)['splinters-gift']] ||
    frontmatters['splinters-gift'][defaultLocale];
  ...
  useProtocolCoherence('splinters-gift', locale);
  return (
